...
\github{https://github.com/jnobre}
\linkedin{http://pt.linkedin.com/in/janobre}
%\skype{jnobre_31}
...
\makecvfooter{\today}{João Nobre~~~·~~~Resumo}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
